...
public:
  ...
  // Returns noise value at (x, y, z) with a given seed
  static float noise3d(float x, float y, float z, int64_t seed);
  ...
  static float octaveNoise3d(float x, float y, float z, int64_t seed,
